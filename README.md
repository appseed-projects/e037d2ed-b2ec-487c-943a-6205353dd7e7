...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-09 18:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e037d2ed-b2ec-487c-943a-6205353dd7e7.git
$ cd e037d2ed-b2ec-487c-943a-6205353dd7e7
```
